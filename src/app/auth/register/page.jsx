                ...
                <form>
                    <fieldset className="fieldset space-y-4">
                        ...
                        <div>
                            ...
                            <input type="email" className="input input-primary text-base w-full px-4 py-2 border border-stone-300 rounded-lg focus:border-primary" placeholder="Your Name" />
                        </div>

                        <div>
                            <label className="label text-sm font-medium text-stone-700 mb-1">Photo URL</label>
                            <input type="email" className="input input-primary text-base w-full px-4 py-2 border border-stone-300 rounded-lg focus:border-primary" placeholder="Your Photo URL" />
                        </div>
