            ...
            <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-sm border border-stone-100">
                ...
                <form>
                    <fieldset className="fieldset space-y-4">
                        ...
                        <label className="label text-sm font-medium text-stone-700 mb-1">Email</label>
                        <input type="email" className="input input-primary text-base w-full px-4 py-2 border border-stone-300 rounded-lg focus:border-primary" placeholder="Email" />
